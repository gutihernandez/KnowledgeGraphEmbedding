...
def main(args):
    ...
    if args.do_train:
        ...
        for step in range(init_step, args.max_steps):
            ...
            pos_score_mod1 = positive_score_model1.clone().detach()
            neg_score_mod1 = negative_score_model1.clone().detach()

            pos_score_mod2 = positive_score_model2.clone().detach()
            neg_score_mod2 = negative_score_model2.clone().detach()
    ...
    if args.do_test:
        ...
        metrics = kge_model.test_step(kge_model, kge_model2, test_triples, all_true_triples, args, lambda1=lambda_1, lambda2=lambda_2)
        log_metrics('Test', step, metrics)

    if args.evaluate_train:
        logging.info('Evaluating on Training Dataset...')
        metrics = kge_model.test_step(kge_model, kge_model2, train_triples, all_true_triples, args, lambda1=lambda_1, lambda2=lambda_2)
        log_metrics('Test', step, metrics)
